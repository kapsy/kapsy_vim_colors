...
let g:colors_name = 'kapsy_tokyo_sunset'

hi Normal guifg=Yellow ctermfg=180 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
...
hi Comment guifg=DarkGray ctermfg=245 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE

" hi LineNr guifg=DarkGray ctermfg=243 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
hi LineNr guifg=#778899 ctermfg=236 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
hi ColorColumn guifg=#737373 ctermfg=180 guibg=Black ctermbg=238 gui=NONE cterm=NONE term=NONE

hi NonText guifg=Black ctermfg=16 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
hi Directory guifg=Yellow ctermfg=180 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
hi Title guifg=NONE ctermfg=NONE guibg=NONE ctermbg=NONE gui=NONE cterm=NONE term=NONE

hi Search guifg=White ctermfg=224 guibg=#778899 ctermbg=236 gui=NONE cterm=NONE term=NONE
hi Visual guifg=White ctermfg=223 guibg=#778899 ctermbg=236 gui=NONE cterm=NONE term=NONE
" hi Visual guifg=NONE ctermfg=NONE guibg=#778899 ctermbg=236 gui=NONE cterm=NONE term=NONE
hi Todo guifg=Yellow ctermfg=226 guibg=Black ctermbg=16 gui=bold cterm=bold term=bold

hi FoldColumn guifg=Yellow ctermfg=180 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
hi Folded guifg=Yellow ctermfg=180 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
hi Statement guifg=Yellow ctermfg=180 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
hi PreProc guifg=Yellow ctermfg=180 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
hi Constant guifg=Yellow ctermfg=180 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
hi Type guifg=Yellow ctermfg=180 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
...
hi TabLineFill guifg=White ctermfg=223 guibg=#778899 ctermbg=236 gui=NONE cterm=NONE term=NONE

hi StatusLine guifg=White ctermfg=223 guibg=#778899 ctermbg=236 gui=NONE cterm=NONE term=NONE
hi StatusLineNC guifg=NONE ctermfg=NONE guibg=#778899 ctermbg=236 gui=NONE cterm=NONE term=NONE
hi VertSplit guifg=#778899 ctermfg=236 guibg=#778899 ctermbg=236 gui=NONE cterm=NONE term=NONE

" Sets a column at line 80.
if (exists('+colorcolumn'))
set colorcolumn=80
  hi ColorColumn guifg=NONE ctermfg=NONE guibg=#778899 ctermbg=233 gui=NONE cterm=NONE term=NONE
endif

hi MoreMsg guifg=Yellow ctermfg=217 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
hi Question guifg=Yellow ctermfg=217 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
hi SpecialKey guifg=Yellow ctermfg=245 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
...
" hi rubyStringDelimiter guifg=White ctermfg=15 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
" hi rubyStringEscape guifg=White ctermfg=15 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
" hi rubyRegexpEscape guifg=White ctermfg=15 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
" hi rubyRegexpAnchor guifg=White ctermfg=15 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
" hi rubyRegexpSpecial guifg=White ctermfg=15 guibg=Black ctermbg=16 gui=NONE cterm=NONE term=NONE
...
" hi markdownLinkText guifg=White ctermfg=15 guibg=Black ctermbg=16 gui=underline cterm=underline term=underline
...
" hi helpHyperTextJump guifg=White ctermfg=15 guibg=Black ctermbg=16 gui=underline cterm=underline term=underline
